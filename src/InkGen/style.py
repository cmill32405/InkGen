...
class DrawingStyle(Style):
    ...
    def create_from_dict(cls, data: object) -> DrawingStyle:
        ...
        style = cls(
            name=_style_required_field(payload, "name", "DrawingStyle"),
...
class Font:
    ...
    def __init__(
        ...
        self._font_paths = []
        self._requested_family: str | list[str] = family
    ...
    def create_from_dict(cls, data: object) -> Font:
        ...
        font = Font(
            family=_style_required_field(payload, "family", "Font"),
    ...
    def _get_paths(self) -> None:
        ...
        if self._platform == "Windows":
            ...
            paths = ["C:/Windows/Fonts/", user_folder + "AppData/Local/Microsoft/Windows/Fonts/"]
        elif self._platform == "Darwin":
            paths = ["/System/Library/Fonts/", "/Library/Fonts/", "~/Library/Fonts/", "/System Folder/Fonts/"]
            ...
            raise ValueError(
                "This class currently only supports \
    ...
    def family(self, family: str | list[str]) -> None:
        ...
        """
        coerced = _coerce_font_family(family)
        self._requested_family = list(coerced) if isinstance(coerced, list) else coerced
        self._font.set_family(coerced)

    @property
    def requested_family(self) -> str | list[str]:
        """Return the family value requested before font-manager resolution."""
        return list(self._requested_family) if isinstance(self._requested_family, list) else self._requested_family
