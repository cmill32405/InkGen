...
| Closed P1 domain | Unknown primitives, rounded corners, gradients, rounded polygons, dashes, offsets, caps, joins, and miter-limit variants fail loudly |
...
- The base P1 domain rejects unknown primitives, zoning, rounded geometry,
  gradients, and unsupported stroke controls instead of producing a visually
  plausible approximation. P2 through P5 add separately proven Bezier, text,
  arc, and linear-path domains.
