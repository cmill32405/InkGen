...
| Flow document outputs | Paragraph/table/drawing export to DOCX, HTML, RTF, and text; native DOCX DrawingML packaging for vector and image drawings | Becoming the drawing renderer source of truth or raster decoder |
