"""Filter Cosmic Ray work items to the TABLE-CELL-ALIGNMENT-P2 rows."""
...
(
  ...
  AND definition_name = '_normalize_vertical_alignment'
  AND start_pos_row BETWEEN 448 AND 454
)
OR (
  module_path = 'src/InkGen/table.py'
  AND definition_name = 'vertical_alignment'
  AND start_pos_row BETWEEN 748 AND 766
)
)
...
def filter_work_items(db_path: Path, *, clear_results: bool) -> tuple[int, int]:
    """Restrict a Cosmic Ray database to TABLE-CELL-ALIGNMENT-P2 work items."""
