"""Filter Cosmic Ray work items to CAD-ZONING-FINITE-P2 rows."""
...
AND (
  ...
  OR (
    definition_name = '_is_finite_nonnegative_number'
    AND start_pos_row BETWEEN 393 AND 401
  )
)
...
def filter_work_items(db_path: Path, *, clear_results: bool) -> tuple[int, int]:
    """Restrict a Cosmic Ray database to CAD zoning finite-boundary checks."""
