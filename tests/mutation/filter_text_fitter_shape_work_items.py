"""Filter Cosmic Ray work items to TEXT-FITTER-SHAPE-P2 rows."""
...
AND (
  (
    ...
    AND start_pos_row BETWEEN 50 AND 58
  )
  OR (
    definition_name IN (
    ...
    AND start_pos_row BETWEEN 100 AND 148
  )
  OR (
    definition_name = 'component_to_fitter_shape'
    AND start_pos_row BETWEEN 743 AND 744
  )
)
...
def filter_work_items(db_path: Path, *, clear_results: bool) -> tuple[int, int]:
    """Restrict a Cosmic Ray database to TEXT-FITTER-SHAPE-P2 boundary checks."""
