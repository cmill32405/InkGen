"""Filter Cosmic Ray work items to PATH-DRAWING-LIVE-COMMANDS-P2 rows."""
...
AND (
    (
        definition_name = '_normalize_path_drawing_commands'
        AND start_pos_row BETWEEN 129 AND 136
    )
    OR (
...
def filter_work_items(db_path: Path, *, clear_results: bool) -> tuple[int, int]:
    """Restrict a Cosmic Ray database to live PathDrawing command checks."""
