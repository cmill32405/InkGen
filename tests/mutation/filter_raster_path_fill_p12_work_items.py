"""Filter Cosmic Ray work items to raster path fill P12."""
...
AND definition_name IN ('_render_path_component', '_scaled_path_subpaths', '_render_nonzero_path_fill')
...
def filter_work_items(db_path: Path) -> tuple[int, int]:
    """Restrict a Cosmic Ray database to P12 proof-critical wiring and helpers."""
