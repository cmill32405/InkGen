"""Filter Cosmic Ray work items to the CAD-ZONING-P1 proof-critical rows."""
...
(
  ...
  AND definition_name = '_set_margins'
  AND start_pos_row IN (163, 167, 168, 169, 170)
)
OR (
  module_path = 'src/InkGen/cad_component_groups.py'
  AND definition_name = '_set_zoning_widths'
  AND start_pos_row IN (185, 189, 190, 191, 192)
)
)
...
def filter_work_items(db_path: Path, *, clear_results: bool) -> tuple[int, int]:
    """Restrict a Cosmic Ray database to CAD-ZONING-P1 proof-critical work items."""
