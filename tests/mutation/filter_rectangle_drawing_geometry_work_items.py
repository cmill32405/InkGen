"""Filter Cosmic Ray work items to RECTANGLE-DRAWING-GEOMETRY-P2 rows."""
...
AND (
  ...
  OR (definition_name = '__post_init__' AND start_pos_row BETWEEN 92 AND 101)
  OR (definition_name = '_coerce_finite_non_negative_float' AND start_pos_row BETWEEN 739 AND 751)
)
"""


def filter_work_items(db_path: Path, *, clear_results: bool) -> tuple[int, int]:
    """Restrict a Cosmic Ray database to neutral rectangle geometry checks."""
