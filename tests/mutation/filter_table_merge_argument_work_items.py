"""Filter Cosmic Ray work items to the TABLE-MERGE-ARG-P2 rows."""
...
(
  ...
  AND definition_name = 'merge'
  AND start_pos_row BETWEEN 962 AND 977
)
...
def filter_work_items(db_path: Path, *, clear_results: bool) -> tuple[int, int]:
    """Restrict a Cosmic Ray database to TABLE-MERGE-ARG-P2 work items."""
