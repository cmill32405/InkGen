"""Filter Cosmic Ray work items to the document-model PDF live-path rows."""
...
AND start_pos_row BETWEEN 3287 AND 3289
"""


def filter_work_items(db_path: Path, *, clear_results: bool) -> tuple[int, int]:
    """Restrict a Cosmic Ray database to document-model PDF live-path checks."""
