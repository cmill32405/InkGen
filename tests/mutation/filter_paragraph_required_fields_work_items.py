"""Filter Cosmic Ray work items to PARAGRAPH-REQUIRED-FIELDS-P2 rows."""
...
AND (
  (
    ...
    AND start_pos_row BETWEEN 409 AND 434
  )
  OR (
    definition_name = '_required_paragraph_field'
    AND start_pos_row BETWEEN 612 AND 616
  )
)
...
def filter_work_items(db_path: Path, *, clear_results: bool) -> tuple[int, int]:
    """Restrict a Cosmic Ray database to paragraph required-field checks."""
