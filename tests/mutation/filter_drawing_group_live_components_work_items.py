"""Filter Cosmic Ray work items to DRAWING-GROUP-LIVE-COMPONENTS-P2 rows."""
...
AND (
  (
    ...
    AND start_pos_row BETWEEN 341 AND 344
  )
  OR (
    definition_name = 'to_group'
    AND start_pos_row BETWEEN 360 AND 364
  )
)
...
def filter_work_items(db_path: Path, *, clear_results: bool) -> tuple[int, int]:
    """Restrict a Cosmic Ray database to live drawing-group component checks."""
