"""Filter Cosmic Ray work items to drawing-style renderer live-path rows."""
...
AND (
  ...
  OR (
    ...
    AND definition_name IN ('_style_operators', '_paint_operator')
    AND start_pos_row BETWEEN 1125 AND 1164
  )
)
"""
...
def filter_work_items(db_path: Path, *, clear_results: bool) -> tuple[int, int]:
    """Restrict a Cosmic Ray database to drawing-style renderer live paths."""
