"""Filter Cosmic Ray work items to PARAGRAPH-TABSTOP-LEADER-P2 rows."""
...
AND (
  (
    ...
    AND start_pos_row = 51
  )
  OR (
    definition_name = '_normalize_tab_stop_leader'
    AND start_pos_row BETWEEN 617 AND 621
  )
)
...
def filter_work_items(db_path: Path, *, clear_results: bool) -> tuple[int, int]:
    """Restrict a Cosmic Ray database to tab-stop leader checks."""
