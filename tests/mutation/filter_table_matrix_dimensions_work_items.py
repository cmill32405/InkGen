"""Filter Cosmic Ray work items to the TABLE-MATRIX-DIMENSIONS-P2 rows."""
...
(
  ...
  AND start_pos_row BETWEEN 327 AND 333
)
...
def filter_work_items(db_path: Path, *, clear_results: bool) -> tuple[int, int]:
    """Restrict a Cosmic Ray database to TABLE-MATRIX-DIMENSIONS-P2 work items."""
