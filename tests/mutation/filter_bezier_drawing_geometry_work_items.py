"""Filter Cosmic Ray work items to BEZIER-DRAWING-GEOMETRY-P2 rows."""
...
AND (
  ...
  OR (definition_name = '__post_init__' AND start_pos_row BETWEEN 246 AND 254)
  OR (definition_name = '__post_init__' AND start_pos_row BETWEEN 278 AND 288)
)
"""


def filter_work_items(db_path: Path, *, clear_results: bool) -> tuple[int, int]:
    """Restrict a Cosmic Ray database to neutral Bezier geometry checks."""
