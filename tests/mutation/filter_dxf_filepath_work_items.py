"""Filter Cosmic Ray work items to DXF filepath rows."""
...
def filter_work_items(db_path: Path, *, clear_results: bool) -> tuple[int, int]:
    """Restrict a Cosmic Ray database to DXF filepath validation checks."""
