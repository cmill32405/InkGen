"""Filter Cosmic Ray work items to text-style renderer live-path rows."""
...
def filter_work_items(db_path: Path, *, clear_results: bool) -> tuple[int, int]:
    """Restrict a Cosmic Ray database to text-style renderer live paths."""
