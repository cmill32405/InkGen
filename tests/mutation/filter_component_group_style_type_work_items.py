"""Filter Cosmic Ray work items to COMPONENT-GROUP-STYLE-TYPE-P2 rows."""
...
AND (
  (
    definition_name = '_component_group_style_class'
    AND start_pos_row BETWEEN 2216 AND 2220
  )
  OR (
    definition_name = 'create_from_dict'
    AND start_pos_row BETWEEN 2269 AND 2277
  )
)
...
def filter_work_items(db_path: Path, *, clear_results: bool) -> tuple[int, int]:
    """Restrict a Cosmic Ray database to component-group style type checks."""
