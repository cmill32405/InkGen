"""Filter Cosmic Ray work items to flow-document drawing label hydration rows."""
...
AND start_pos_row BETWEEN 919 AND 927
...
def filter_work_items(db_path: Path, *, clear_results: bool) -> tuple[int, int]:
    """Restrict a Cosmic Ray database to drawing-label hydration checks."""
