"""Filter Cosmic Ray work items to PDF-FONT-TOUNICODE-P3 rows."""
...
AND (
  (
    ...
    AND start_pos_row BETWEEN 423 AND 444
  )
  OR (
    definition_name = '_pdf_font_object'
    AND start_pos_row BETWEEN 447 AND 465
  )
  OR (
    definition_name = 'to_pdf_bytes'
    AND start_pos_row BETWEEN 1390 AND 1406
  )
)
...
def filter_work_items(db_path: Path, *, clear_results: bool) -> tuple[int, int]:
    """Restrict a Cosmic Ray database to PDF ToUnicode proof-critical rows."""
