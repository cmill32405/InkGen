"""Filter Cosmic Ray work items to flow-document drawing component rows."""
...
AND (
  (
    definition_name IS NULL
    AND start_pos_row BETWEEN 33 AND 45
  )
  OR (
...
def filter_work_items(db_path: Path, *, clear_results: bool) -> tuple[int, int]:
    """Restrict a Cosmic Ray database to drawing component envelope checks."""
