"""Filter Cosmic Ray work items to PARAGRAPH-ROOT-PAYLOAD-P2 rows."""
...
AND (
  (
    ...
    AND start_pos_row = 404
  )
  OR (
    definition_name = '_paragraph_payload'
    AND start_pos_row BETWEEN 571 AND 578
  )
)
...
def filter_work_items(db_path: Path, *, clear_results: bool) -> tuple[int, int]:
    """Restrict a Cosmic Ray database to paragraph root-payload checks."""
