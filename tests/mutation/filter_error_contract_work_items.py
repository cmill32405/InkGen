"""Filter Cosmic Ray work items to the ERRORS-P1 proof-critical rows."""
...
FILTER_SQL = """
module_path IN ('src/InkGen/errors.py', 'src/InkGen/__init__.py')
"""


def filter_work_items(db_path: Path, *, clear_results: bool) -> tuple[int, int]:
    """Restrict a Cosmic Ray database to ERRORS-P1 proof-critical work items."""
