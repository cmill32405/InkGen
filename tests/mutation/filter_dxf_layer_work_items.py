"""Filter Cosmic Ray work items to DXF layer-boundary proof-critical rows."""
...
AND (
  (definition_name = '__post_init__' AND start_pos_row IN (43))
  OR (definition_name = '_coerce_dxf_layer' AND start_pos_row IN (68))
  OR (definition_name = 'add_group' AND start_pos_row IN (85, 86, 87))
)
...
def filter_work_items(db_path: Path, *, clear_results: bool) -> tuple[int, int]:
    """Restrict a Cosmic Ray database to DXF layer-boundary work items."""
