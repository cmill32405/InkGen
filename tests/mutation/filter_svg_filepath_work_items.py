"""Filter Cosmic Ray work items to the SVG-FILEPATH-P2 proof-critical rows."""
...
AND (
  (definition_name = 'create_svg' AND start_pos_row = 1726)
  OR (definition_name = '_normalize_output_path' AND start_pos_row BETWEEN 1742 AND 1755)
)
AND (
...
def filter_work_items(db_path: Path, *, clear_results: bool) -> tuple[int, int]:
    """Restrict a Cosmic Ray database to SVG-FILEPATH-P2 work items."""
