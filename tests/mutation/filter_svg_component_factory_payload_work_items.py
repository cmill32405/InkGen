"""Filter Cosmic Ray work items to SVG-COMPONENT-FACTORY-PAYLOAD-P2 rows."""
...
AND (
  (
    definition_name IN (
      ...
      '_svg_component_path_entries'
    )
    AND start_pos_row BETWEEN 110 AND 170
  )
  OR (
    definition_name = 'create_from_dict'
    AND start_pos_row BETWEEN 1352 AND 1362
  )
)
...
def filter_work_items(db_path: Path, *, clear_results: bool) -> tuple[int, int]:
    """Restrict a Cosmic Ray database to SVG component factory payload items."""
