"""Filter Cosmic Ray work items to the SINGLE-DIM-P1 proof-critical rows."""
...
AND definition_name = 'size'
AND start_pos_row BETWEEN 475 AND 485
"""


def filter_work_items(db_path: Path, *, clear_results: bool) -> tuple[int, int]:
    """Restrict a Cosmic Ray database to SINGLE-DIM-P1 proof-critical work items."""
