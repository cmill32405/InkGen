"""Filter Cosmic Ray work items to the TEXT-P1 proof-critical rows."""
...
OR (
  ...
  AND start_pos_row BETWEEN 111 AND 112
)
OR (
  module_path = 'src/InkGen/dxf_generator.py'
  AND definition_name = '_text_entity'
  AND start_pos_row BETWEEN 199 AND 212
)
)
...
def filter_work_items(db_path: Path, *, clear_results: bool) -> tuple[int, int]:
    """Restrict a Cosmic Ray database to TEXT-P1 proof-critical work items."""
