"""Filter Cosmic Ray work items to the FONT-P1 proof-critical rows."""
...
AND (
  (
    ...
    AND start_pos_row BETWEEN 15 AND 57
  )
  OR (
...
def filter_work_items(db_path: Path, *, clear_results: bool) -> tuple[int, int]:
    """Restrict a Cosmic Ray database to FONT-P1 proof-critical work items."""
