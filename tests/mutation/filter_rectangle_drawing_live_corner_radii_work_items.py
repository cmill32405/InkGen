"""Filter Cosmic Ray work items to RECTANGLE-DRAWING-LIVE-CORNER-RADII-P2 rows."""
...
AND start_pos_row BETWEEN 145 AND 185
AND definition_name IN ('_normalize_rectangle_drawing_corner_radii', '__post_init__', 'to_component')
...
def filter_work_items(db_path: Path, *, clear_results: bool) -> tuple[int, int]:
    """Restrict a Cosmic Ray database to rectangle drawing corner-radii live checks."""
