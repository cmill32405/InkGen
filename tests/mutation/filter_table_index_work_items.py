"""Filter Cosmic Ray work items to the TABLE-INDEX-P2 rows."""
...
AND NOT (
  module_path = 'src/InkGen/table.py'
  AND definition_name = '_normalize_public_index'
  AND start_pos_row = 521
)
AND NOT (
  module_path = 'src/InkGen/table.py'
  AND definition_name = '_validate_insert_index'
  AND start_pos_row = 399
)
"""


def filter_work_items(db_path: Path, *, clear_results: bool) -> tuple[int, int]:
    """Restrict a Cosmic Ray database to TABLE-INDEX-P2 work items."""
