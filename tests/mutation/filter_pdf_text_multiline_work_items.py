"""Filter Cosmic Ray work items to PDF multiline text proof-critical rows."""
...
AND start_pos_row BETWEEN 1547 AND 1561
...
def filter_work_items(db_path: Path, *, clear_results: bool) -> tuple[int, int]:
    """Restrict a Cosmic Ray database to PDF multiline text work items."""
