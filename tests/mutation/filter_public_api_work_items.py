"""Filter Cosmic Ray work items to the PUBLIC-API-P1 proof-critical rows."""
...
FILTER_SQL = """
module_path = 'src/InkGen/__init__.py'
"""


def filter_work_items(db_path: Path, *, clear_results: bool) -> tuple[int, int]:
    """Restrict a Cosmic Ray database to PUBLIC-API-P1 proof-critical work items."""
