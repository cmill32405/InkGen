"""Filter Cosmic Ray work items to PARAGRAPH-POSITION-PAYLOAD-P2 rows."""
...
AND (
  (
    ...
    AND start_pos_row BETWEEN 409 AND 413
  )
  OR (
    definition_name = '_paragraph_position_payload'
    AND start_pos_row BETWEEN 619 AND 623
  )
)
...
def filter_work_items(db_path: Path, *, clear_results: bool) -> tuple[int, int]:
    """Restrict a Cosmic Ray database to paragraph position-payload checks."""
