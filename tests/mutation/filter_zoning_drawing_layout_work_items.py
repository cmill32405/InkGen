"""Filter Cosmic Ray work items to ZONING-DRAWING-LAYOUT-P2 rows."""
...
AND (
  (
    ...
    AND start_pos_row = 725
  )
  OR (
    definition_name = '_validate_zoning_layout'
    AND start_pos_row BETWEEN 880 AND 885
  )
)
...
def filter_work_items(db_path: Path, *, clear_results: bool) -> tuple[int, int]:
    """Restrict a Cosmic Ray database to zoning layout validation work items."""
