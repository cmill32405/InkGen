"""Filter Cosmic Ray work items to POLYGONAL-DRAWING-GEOMETRY-P2 rows."""
...
(
  (
    ...
    AND definition_name IN ('__init__', '_create_valid_polygon', 'points')
    AND start_pos_row BETWEEN 924 AND 1048
  )
  OR (
...
def filter_work_items(db_path: Path, *, clear_results: bool) -> tuple[int, int]:
    """Restrict a Cosmic Ray database to neutral polygon geometry checks."""
