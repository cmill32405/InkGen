"""Filter Cosmic Ray work items to CAD-ZONING-FACTORY-PAYLOAD-P2 rows."""
...
AND (
  (
    ...
    AND start_pos_row BETWEEN 362 AND 403
  )
  OR (
    definition_name IN (
      '_zoning_payload',
    ...
    AND start_pos_row BETWEEN 406 AND 443
  )
)
...
def filter_work_items(db_path: Path, *, clear_results: bool) -> tuple[int, int]:
    """Restrict a Cosmic Ray database to legacy CAD zoning factory payload items."""
