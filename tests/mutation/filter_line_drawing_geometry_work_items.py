"""Filter Cosmic Ray work items to LINE-DRAWING-GEOMETRY-P2 rows."""
...
AND (
  ...
  OR (definition_name = '__post_init__' AND start_pos_row BETWEEN 131 AND 137)
)
"""


def filter_work_items(db_path: Path, *, clear_results: bool) -> tuple[int, int]:
    """Restrict a Cosmic Ray database to neutral line geometry checks."""
