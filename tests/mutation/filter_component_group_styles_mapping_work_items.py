"""Filter Cosmic Ray work items to COMPONENT-GROUP-STYLES-MAPPING-P2 rows."""
...
AND (
  (
    definition_name = '_component_group_style_cache'
    AND start_pos_row BETWEEN 2198 AND 2203
  )
  OR (
    definition_name = 'create_from_dict'
    AND (
      start_pos_row = 2247
      OR start_pos_row BETWEEN 2264 AND 2271
    )
  )
)
"""
...
def filter_work_items(db_path: Path, *, clear_results: bool) -> tuple[int, int]:
    """Restrict a Cosmic Ray database to component-group style-cache checks."""
