"""Filter Cosmic Ray work items to the ARC-P1 proof-critical rows."""
...
def filter_work_items(db_path: Path, *, clear_results: bool) -> tuple[int, int]:
    """Restrict a Cosmic Ray database to ARC-P1 proof-critical work items."""
