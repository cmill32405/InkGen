"""Export source-fresh PDF text-presentation mutation evidence."""
...
SOURCE_PATHS = (
    Path("src/InkGen/style.py"),
    Path("src/InkGen/component.py"),
    Path("src/InkGen/pdf_generator.py"),
    Path("tests/test_pdf_text_presentation_contract.py"),
    Path("tests/mutation/pdf_text_presentation_cosmic_ray.toml"),
    Path("tests/mutation/filter_pdf_text_presentation_work_items.py"),
)
...
def export_evidence(database: Path, output: Path) -> None:
    """Write deterministic mutation outcomes plus source-freshness metadata."""
