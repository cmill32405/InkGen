"""Filter Cosmic Ray work items to the PDF-PATH-COMMAND-TYPE-P2 rows."""
...
AND definition_name = '_path_command_from_dict'
AND start_pos_row BETWEEN 304 AND 315
AND operator_name NOT LIKE 'core/ReplaceBinaryOperator_BitOr_%'
"""


def filter_work_items(db_path: Path, *, clear_results: bool) -> tuple[int, int]:
    """Restrict a Cosmic Ray database to PDF-PATH-COMMAND-TYPE-P2 work items."""
