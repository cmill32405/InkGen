"""Filter Cosmic Ray work items to the layer canvas live-path rows."""
...
AND definition_name = 'add_component_group'
AND start_pos_row BETWEEN 174 AND 177
"""


def filter_work_items(db_path: Path, *, clear_results: bool) -> tuple[int, int]:
    """Restrict a Cosmic Ray database to layer canvas live-path checks."""
