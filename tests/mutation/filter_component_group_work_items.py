"""Filter Cosmic Ray work items to the COMPONENT-GROUP-P1 proof-critical rows."""
...
AND definition_name = 'add_component'
AND start_pos_row BETWEEN 2070 AND 2095
"""


def filter_work_items(db_path: Path, *, clear_results: bool) -> tuple[int, int]:
    """Restrict a Cosmic Ray database to COMPONENT-GROUP-P1 proof-critical work items."""
